        ...
        <div className = "footer-wrapper bck_black">
            <div className = "row">
                ...
                <div className = "col1-of-2 copyright">
                    ...
                    <div>BholDhoka, Balkumari, Lalitpur, Nepal</div>
                    <div>contact us at: 9851024995, 9801036067</div>
                   
                    <br/>
                    <br/>
                    <br/>
                    <div className = "webmaster">
                    <a href="https://github.com/pixellogic">webiste created by: Pixellogic</a>
                    </div>
